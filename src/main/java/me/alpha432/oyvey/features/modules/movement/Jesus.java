...
public class Jesus
    ...
    public Setting<Boolean> cancelVehicle = this.register(new Setting <>("NoVehicle", false));
    public Setting<EventMode> eventMode = this.register(new Setting <>("Jump", EventMode.PRE, v -> this.mode.getValue() == Mode.TRAMPOLINE));
